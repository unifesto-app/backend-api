...
;
;
const supabaseUrl = ("TURBOPACK compile-time value", "https://api.unifesto.app");
const supabaseKey = ("TURBOPACK compile-time value", "sb_publishable_cPr8iHniQZXIqwyikzpuDg_mgB3g3Ze");
...
async function middleware(request) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2f$middleware$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["createClient"])(request);
}
const config = {
    matcher: [
